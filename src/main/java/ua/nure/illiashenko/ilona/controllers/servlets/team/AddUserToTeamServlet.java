...
import ua.nure.illiashenko.ilona.controllers.servlets.feedback.DeleteFeedbackServlet;
...
public class AddUserToTeamServlet extends HttpServlet {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AddUserToTeamServlet.class);

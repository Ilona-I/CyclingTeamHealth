...
<div class="row div_menu center_content">
    ...
    <div id="userPresent2" class="center_content div_selected_menu_item"><a href="http://localhost:8080/CyclingTeamHealth_war/users.jsp" class="a_selected_menu_item">Team members</a></div>
...
<div style="margin-left: 30%; margin-top: 40px; width: 40%;">
    <h1>Users</h1>
    <br>
    <div id="users">

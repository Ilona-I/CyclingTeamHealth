...
<div class="row div_menu center_content">
    ...
    <div id="userPresent1" class="center_content div_selected_menu_item"><a href="http://localhost:8080/CyclingTeamHealth_war/profile.jsp" class="a_selected_menu_item">My profile</a></div>

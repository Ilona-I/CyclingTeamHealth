...
<head>
    ...
    <link rel="stylesheet" href="css/feedbacks.css" type="text/css">
...
<div class="row div_menu center_content">
    ...
    <div class="center_content div_selected_menu_item"><a href="http://localhost:8080/CyclingTeamHealth_war/feedbacks.jsp" class="a_selected_menu_item">Feedbacks</a></div>
...
<div class="center_content" style="margin-top: 40px;">
    <h3>Feedbacks</h3>
</div>
<div class="div_feedbacks" id="feedbacks">

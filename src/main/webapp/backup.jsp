...
<head>
    ...
    <link rel="stylesheet" href="css/backup.css" type="text/css">
...
<div class="row div_menu center_content">
    ...
    <div id="admin" class="center_content div_selected_menu_item"> <a href="http://localhost:8080/CyclingTeamHealth_war/backup.jsp" class="a_selected_menu_item">Backup</a></div>
...
<div class="row div_backup center_content">
    <button onclick="backUp()" class="center_content button_backup">Back up database</button>
    <div class="div_line"></div>
    <button onclick="restore()" class="center_content button_backup">Restore database</button>
</div>
